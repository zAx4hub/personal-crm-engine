...
> Personal CRM engine with relationship graphs

**Author:** zAx4hub

## Problem

Personal CRM engine with relationship graphs. Teams often rely on closed SaaS, brittle scripts, or untested prototypes for this niche.

## Solution

`personal-crm-engine` is an installable TypeScript/Node toolkit by **zAx4hub** with a real **policy** engine, CLI, examples, and tests.
...
1. Core policy engine tailored to the problem
